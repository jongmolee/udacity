...
class ReplayBuffer:
    """Fixed-size buffer to store experice tuples."""
...
class Actor:
    ...
    def build_model(self):
        ...
        # Try different layer sizes, activations, add batch normalization, reularizers, etc.
        
        # Add final ouput layer with sigmoid activation
        ...
        # Defind loss function using action value (Q value) gradients
...
class Critic:
    ...
    def build_model(self):
        ...
        net_states = layers.Dense(units=32, activation='relu', use_bias = False,
            kernel_regularizer = regularizers.l2(0.01), activity_regularizer = regularizers.l1(0.01))(states)
        net_states = layers.BatchNormalization()(net_states)
        net_states = layers.Dropout(0.6)(net_states)
        
        net_states = layers.Dense(units=64, activation='relu', use_bias = False,
        ...
        net_actions = layers.Dense(units=32, activation='relu', use_bias = False,
        ...
        net_actions = layers.Dense(units=64, activation='relu', use_bias = False,
